module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('offers', 'valid_until', {
        transaction,
      });

      await queryInterface.removeColumn('offers', 'valid_from', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('offers', 'title', { transaction });
      ...
      await queryInterface.removeColumn('locations', 'state', { transaction });

      await queryInterface.removeColumn('locations', 'city', { transaction });

      await queryInterface.removeColumn('buses', 'driverId', { transaction });

      await queryInterface.removeColumn('buses', 'operator_name', {
        transaction,
      });

      await queryInterface.removeColumn('buses', 'bus_number', { transaction });
      ...
      await queryInterface.removeColumn('bookings', 'busId', { transaction });
