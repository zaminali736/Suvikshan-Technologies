...
const ListOffers = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_OFFERS');
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>ValidFrom</p>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/offers/offers-edit/?id=${item.id}`}
                  pathView={`/offers/offers-view/?id=${item.id}`}
