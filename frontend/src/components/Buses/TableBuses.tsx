...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/buses/busesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureBusesCols';
...
const TableSampleBuses = ({
  ...
  useEffect(() => {
    if (busesNotify.showNotification) {
      notify(busesNotify.typeNotification, busesNotify.textNotification);
    }
  }, [busesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/buses/buses-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {buses && Array.isArray(buses) && !showGrid && (
        <ListBuses
          buses={buses}
          loading={loading}
...
export default TableSampleBuses;
